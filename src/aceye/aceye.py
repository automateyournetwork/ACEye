...
class ACEye():
    ...
    def aceye(self):
        ...
        self.all_files(parsed_json)
        parsed_json = json.dumps(self.endpoints_ip(), indent=4, sort_keys=True)
        self.all_files(parsed_json)
    ...
    def endpoints_ip(self):
        self.url = f"{ self.aci }/api/class/fvIp.json"
        response = requests.request("GET", self.url, cookies = self.cookie, verify=False)
        print(f"<Endpoints IP Status code { response.status_code } for { self.url }>")
        response_dict  = response.json()
        return(response_dict)
    ...
    def json_file(self, parsed_json):
        ...
        if "fvIp" in self.url:
            with open('Endpoints IP/JSON/Endpoints IP.json', 'w' ) as f:
                f.write(parsed_json)
    ...
    def yaml_file(self, parsed_json):
        ...
        if "fvIp" in self.url:
            with open('Endpoints IP/YAML/Endpoints IP.yaml', 'w' ) as f:
                f.write(clean_yaml)
    ...
    def csv_file(self, parsed_json):
        ...
        if "fvIp" in self.url:
            with open('Endpoints IP/CSV/Endpoints IP.csv', 'w' ) as f:
                f.write(csv_output)
    ...
    def markdown_file(self, parsed_json):
        ...
        if "fvIp" in self.url:
            with open('Endpoints IP/Markdown/Endpoints IP.md', 'w' ) as f:
                f.write(markdown_output)
    ...
    def html_file(self, parsed_json):
        ...
        if "fvIp" in self.url:
            with open('Endpoints IP/HTML/Endpoints IP.html', 'w' ) as f:
                f.write(html_output)
    ...
    def mindmap_file(self, parsed_json):
        ...
        if "fvIp" in self.url:
            with open('Endpoints IP/Mindmap/Endpoints IP.md', 'w' ) as f:
                f.write(mindmap_output)
